...
public class InventoryService {
    ...
    public List<InventoryDTO> getAllItems() {
        List<InventoryEntity>itemList = inventoryRepo.findAll();
    ...
    public InventoryDTO saveItem(InventoryDTO inventoryDTO) {
        inventoryRepo.save(modelMapper.map(inventoryDTO, InventoryEntity.class));
        return inventoryDTO;
    }
    ...
    public InventoryDTO getItemById(Integer itemId) {
        InventoryEntity item = inventoryRepo.getItemById(itemId);
